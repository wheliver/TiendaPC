...
public class ListaFacturastotal extends JDialog {
	...
	public ListaFacturastotal() {
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"           <<Todos>>", "Pagado", "No pagado"}));
		comboBox.setBounds(54, 36, 150, 20);
		panel_1.add(comboBox);
		
		JLabel lblNewLabel = new JLabel("Tipo de facturas");
	...
	public void loadTable(int opcion) {
		...
		/*if(opcion == 0) {
			for (Factura componenter : Tienda.getInstance().getMisfacturas()) {
